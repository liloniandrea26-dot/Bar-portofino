    ...
    >
      <div className="flex h-12 w-12 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full bg-white/15 ring-1 ring-white/50 backdrop-blur-sm">
        ...
        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" aria-hidden="true">
          <path d="M12 22 4 7c2.5-1.9 5.2-3 8-3s5.5 1.1 8 3l-8 15z" fill="#F5A25D" />
          <path d="M4 7c2.5-1.9 5.2-3 8-3s5.5 1.1 8 3l-1.2 2.2C16.6 7.6 14.4 6.8 12 6.8S7.4 7.6 5.2 9.2L4 7z" fill="#FF7A59" />
          <circle cx="10.5" cy="11" r="1.3" fill="#FDFBF6" />
          <circle cx="14" cy="13.5" r="1.1" fill="#FDFBF6" />
          <circle cx="11.6" cy="16.5" r="1" fill="#FDFBF6" />
        </svg>
      </div>
    </motion.div>
  );

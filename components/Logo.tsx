...
export default function Logo({
  ...
  return (
    ...
    >
      ...
      >
        {/* Fetta */}
        <path d="M20 36 5 10c4.5-3.5 9.8-5.5 15-5.5S30.5 6.5 35 10L20 36z" fill="#F5A25D" />
        {/* Crosta */}
        <path
        ...
        />
        {/* Condimenti */}
        <circle cx="17" cy="17" r="2.4" fill="#FDFBF6" />
        <circle cx="24" cy="20" r="2" fill="#FDFBF6" />
        <circle cx="19.5" cy="26" r="1.8" fill="#FDFBF6" />
      </svg>
